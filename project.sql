...
-- Q5. Identify the top 5 categories offering the highest average dsicount percentage 
select category,
...
-- Q7. Group the products by categories like Low, Medium, Bulk based on their weightInGms
